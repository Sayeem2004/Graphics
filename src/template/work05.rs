// Imports
use crate::format::{parse, constant, matrix::Matrix, image::Image, file, pixel::Pixel};
...
pub fn filled_sphere(itr: u32) {
    ...
    edges.draw_lines_xy(&mut img, constant::WHITE_PIXEL);
