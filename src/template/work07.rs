// Imports
use crate::template::prev::ver07::algorithm::shape;
use crate::template::prev::ver07::format::{constant, file, image::Image, matrix::Matrix};
use crate::template::prev::ver07::script::parse;
...
pub fn create_work07_images(mode: i32) {
    ...
    parse::parse("data/mdl/w07_robot.mdl", 750, mode);
    ...
    parse::parse("data/mdl/w07_umbrella.mdl", 750, mode);
}
